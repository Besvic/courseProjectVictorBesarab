...
public class Const {
    public static final String FUNCTION_COMPLETED_SUCCESSFUL = "function completed successful";
    ...
    public static final String FUNCTION_FAILED = "function failed";
    public static final String RegistrationUser = "registrationUser";
    ...
    public static final String INITIALIZE_COST_LABEL_FOR_CREATE_ORDER = "INITIALIZE_COST_LABEL_FOR_CREATE_ORDER";
